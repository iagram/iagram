...
| **Palette** (left) | Search; curated elements grouped by category; **All resources**: every first-level resource type of the provider. Items that fit the selected container are highlighted, the rest dimmed. Drag onto the canvas. |
