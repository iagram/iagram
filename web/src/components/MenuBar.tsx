...
export function MenuBar() {
  ...
  const menus: Record<string, Item[]> = {
    File: [
      ...
      { label: 'Home (reference architectures)', onClick: () => s.setShowGallery(true) },
    ...
    Edit: [
      ...
      { sep: true },
      { label: 'Cut', shortcut: '⌘X', onClick: s.cutSelection, disabled: !s.nodes.some((n) => n.selected) },
      ...
      { sep: true },
      { label: 'Bring to front', shortcut: '⌘⇧]', onClick: () => s.reorder('front'), disabled: !s.nodes.some((n) => n.selected) },
      { label: 'Bring forward', shortcut: '⌘]', onClick: () => s.reorder('forward'), disabled: !s.nodes.some((n) => n.selected) },
      { label: 'Send backward', shortcut: '⌘[', onClick: () => s.reorder('backward'), disabled: !s.nodes.some((n) => n.selected) },
      { label: 'Send to back', shortcut: '⌘⇧[', onClick: () => s.reorder('back'), disabled: !s.nodes.some((n) => n.selected) },
      { sep: true },
